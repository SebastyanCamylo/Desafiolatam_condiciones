...
btnVerify.addEventListener("click", () => {
    ...
    if (password === "911") {
        //console.log("ok");
        document.getElementById("Password").innerHTML = "Password 1, es Correcta!"
        return
    }

    if (password === "714") {
        //console.log("ok2");
        document.getElementById("Password").innerHTML = "Password 2, es Correcta!"
        return
    }
    if (password === "000") {
        //console.log("ok2");
        document.getElementById("Password").innerHTML = "Una clave con 3 ceros, no es segura!"
        return
    }
